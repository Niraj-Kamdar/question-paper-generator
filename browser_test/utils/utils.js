...
//              css: css=#course_container > div.course_items > div > label > input
...
//   xpath:position: //input
//              css: css=#unit_container > div.unit_items > div > label > input
web.click('//input[@type=\'checkbox\']');
...
if(checking){
web.assertText('//div[@id=\'questions\']/div[2]/div/div[2]/div[2]/div/span[2]', '5');
// xpath:idRelative: //div[@id=\'questions\']/div[2]/div/div[2]/div[3]/div/span[2]
//   xpath:position: //div[3]/div/span[2]
//              css: css=#questions > div:nth-child(2) > div > div.question_info > div.third_row > div > span.difficulty.medium
web.assertText('//div[@id=\'questions\']/div[2]/div/div[2]/div[3]/div/span[2]', 'Medium');
// xpath:idRelative: //div[@id=\'questions\']/div[2]/div/div[2]/div[4]/div/span[2]
//   xpath:position: //div[4]/div/span[2]
//              css: css=#questions > div:nth-child(2) > div > div.question_info > div.fourth_row > div > span.cognitive.comprehension
web.assertText('//div[@id=\'questions\']/div[2]/div/div[2]/div[4]/div/span[2]', 'Comprehension');
...
web.assertText('//div[@id=\'questions\']/div[2]/div/div[2]/div[5]/div', 'who is yoda?');
}
...
//              css: css=#questions > div:nth-child(2) > div > div.delete_question > label > input
...
//              css: css=#options > div:nth-child(1) > label.fake_label > textarea
web.click('//div[@id=\'options\']/div[1]/label[1]/textarea');
// xpath:idRelative: //div[@id=\'options\']/div[1]/label[1]/textarea
//   xpath:position: //div[1]/label[1]/textarea
//              css: css=#options > div:nth-child(1) > label.fake_label > textarea
web.type('//div[@id=\'options\']/div[1]/label[1]/textarea', 'a bounty hunter?');
// xpath:idRelative: //div[@id=\'options\']/div[3]/label[1]/textarea
//   xpath:position: //div[3]/label[1]/textarea
//              css: css=#options > div:nth-child(3) > label.fake_label > textarea
...
//              css: css=#options > div:nth-child(5) > label.fake_label > textarea
...
//              css: css=#options > div:nth-child(7) > label.fake_label > textarea
...
if(checking){
web.assertText('//div[@id=\'template_display\']/div[1]', 'Click Here to view Demo');
// xpath:idRelative: //div[@id=\'template_display\']/div[2]
//   xpath:position: //div[2]/div/div[2]
//              css: css=#template_display > div:nth-child(5)
web.assertText('//div[@id=\'template_display\']/div[2]', 'Mail paper to examiner');
}
