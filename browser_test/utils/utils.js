...
function add_sub(checking) {
  ...
  if (!count) {
    ...
    if (checking) {
      web.assertText(
          '//div[@id=\'questions\']/div[2]/div/div[2]/div[2]/div/span[2]', '5');
      // xpath:idRelative:
...
function add_mcq(checking) {
  ...
  if (!status) {
    ...
    //              css: css=#options > div:nth-child(1) > label.fake_label >
    //              textarea
    web.type('//div[@id=\'options\']/div[1]/label[1]/textarea',
             'a bounty hunter?');
