    ...
    def __call__(self, form, field):
        try:
            ...
            raise ValidationError(field.gettext(
                "Invalid field name in {}.").format(', '.join(self.fieldnames)))
