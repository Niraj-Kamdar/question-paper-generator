...
mark.addEventListener("input", () => { formErrors[1].innerHTML = ""; });

difficulty.setAttribute("placeholder", "Enter difficulty here");
difficulty.addEventListener("input", () => { formErrors[2].innerHTML = ""; });

question.setAttribute("placeholder", "Enter question here");
question.setAttribute("style", "height:" + question.scrollHeight +
