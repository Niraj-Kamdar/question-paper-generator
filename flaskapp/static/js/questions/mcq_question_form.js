...
marksValue.addEventListener("input", () => { clientErrors[1].innerText = ""; });

questionValue.setAttribute("placeholder", "Enter question here");
questionValue.setAttribute("style", "height:" + questionValue.scrollHeight +
...
form.addEventListener("submit", (e) => {
  ...
  validation =
      isValid(questionValue.value, marksValue.value, difficultyValue.value,
              fakeContainer[0].value, fakeContainer[1].value,
              fakeContainer[2].value, fakeContainer[3].value);
