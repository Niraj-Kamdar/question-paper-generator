(function () {
  ...
  const hiddenLabel = Array.from(
    document.getElementsByClassName("hidden_label")
  );
  ...
  const cognitiveFields = Array.from(
    document.getElementsByClassName("cognitive")
  );
  const difficultyFields = Array.from(
    document.getElementsByClassName("difficulty")
  );
  const questionsFields = Array.from(
    document.getElementsByClassName("question")
  );
  const questionTypeFields = Array.from(
    document.getElementsByClassName("question_type")
  );
  const unitFieldsErr = Array.from(document.getElementsByClassName("unit_err"));
  const cognitiveFieldsErr = Array.from(
    document.getElementsByClassName("cognitive_err")
  );
  const difficultyFieldsErr = Array.from(
    document.getElementsByClassName("difficulty_err")
  );
  const questionTypeFieldsErr = Array.from(
    document.getElementsByClassName("question_type_err")
  );
  const questionsFieldsErr = Array.from(
    document.getElementsByClassName("question_err")
  );
  const marksErr = document.getElementsByClassName("marks_err");
  const header = document.getElementsByClassName("header")[0];
  const fieldHeader = Array.from(
    document.getElementsByClassName("field_header")
  );
  const formParts = [
    unitFields,
    cognitiveFields,
