...
const questionsFields =
    Array.from(document.getElementsByClassName("questions"));
...
const questionsFieldsErr =
    Array.from(document.getElementsByClassName("questions_err"));
...
const formParts =
    [ unitFields, cognitiveFields, difficultyFields, questionsFields ];
const formPartsErr = [
  unitFieldsErr, cognitiveFieldsErr, difficultyFieldsErr, questionsFieldsErr
];
