...
Revision ID: 97f236ad7125
Revises: 
Create Date: 2020-06-21 12:48:48.987165
...
def upgrade():
    ...
    op.create_table('course',
                    ...
                    sa.Column('include_asked', sa.Boolean(), nullable=True),
    ...
    op.create_table('question',
                    ...
                    sa.Column('mark', sa.Integer(), nullable=False),
                    sa.Column('difficulty', sa.Enum('Easy', 'Medium', 'Hard',
                                                    name='difficultyenum'), nullable=False),
                    sa.Column('cognitive_level', sa.Enum('Knowledge', 'Comprehension',
                                                         'Application', name='cognitiveenum'), nullable=False),
                    sa.Column('question_type', sa.Enum('sub', 'mcq',
                                                       name='questiontypeenum'), nullable=False),
                    sa.Column('imp', sa.Boolean(), nullable=True),
                    sa.Column('is_asked', sa.Boolean(), nullable=True),
