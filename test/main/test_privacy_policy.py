...
class PrivacyPolicyTestCase(BaseUser):
    def test_privacy_policy(self):
        ...
        self.assertIn(b"We only ask for personal information when we truly need it", response.data)
        self.assertIn(b"We only retain collected information for as long as", response.data)
        ...
        self.assertIn(b"practices around privacy and personal information", response.data)
        self.assertIn(b"If you have any questions about", response.data)
        self.assertIn(b"how we handle user data and personal information", response.data)
