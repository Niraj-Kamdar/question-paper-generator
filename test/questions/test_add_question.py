...
from test.main.base_classes import BaseCourse, BaseUnit
...
class AddQuestionTestCase(BaseUnit):
    def test_add_sub_question(self):
        ...
        new_question = dict(question="Is it okay?",
                            ...
                            imp=True,
                            submit="submit")
        _, question = test_post_request(self, "/course/1/unit/1/question/sub/new/",
                                        new_question, models.Question, 1)

        # Testing if repr method is working
        self.assertEqual(str(question), "Question(Is it okay?, 8, DifficultyEnum.Easy, CognitiveEnum.Application, True)")
