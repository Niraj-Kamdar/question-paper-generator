...
class UserAccountTestCase(BaseUser):
    def test_set_profile(self):
        ...
        set_user = dict(username="nr.nutron", email="nutron@gmail.com", picture=im1, submit="submit")
    ...
    def test_update_profile(self):
        ...
        set_user = dict(username="nr.nutron", email="nutron@gmail.com", picture=im2, submit="submit")
        test_post_request(self, "/account", set_user, models.User, 1)
